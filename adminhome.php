...
<head>
	...
	<body>
		<form align="center" method="POST" action="loginvalidate.php">
			...
			<b class="h3">Password*&nbsp;</b><input class="n2" name="pswd" type="password"  placeholder="enter password" required><br><br>
             ...
             <input class="n3" type="SUBMIT" value="Login" name="SUBMIT">
			 <input class="n4" type="RESET" value="Clear" name="SUBMIT">
		</form>
	</body>
</html>